...
(defvar help-test (make-command
							...
							:long (format nil
														(concatenate 'string
																				 "(test <days>) - Runs the solutions on the example input for each given day "
...
(defvar help-test-all (make-command
											 :form "(test-all)"
											 :short "Tests all loaded days"
											 :long (format nil
																		 (concatenate 'string
																									"(test-all) - Runs the solutions on the example inputs for all days "
...
(defvar commands (list help-ld help-load-all help-test help-test-all help-parse-in
											 help-reload help-reload-all help-bench))
